...
this is used to pos tag the texts using stanford pos tagger
'''
...
def listFiles( srcDir, parseDir ):
    for fileName in os.listdir(srcDir):                            
        ...
        os.system("java -mx300m -cp ""../stanford-postagger-2013-06-20/stanford-postagger.jar"" edu.stanford.nlp.tagger.maxent.MaxentTagger -model ../stanford-postagger-2013-06-20/models/english-left3words-distsim.tagger -textFile " + filePath + ">" + parsedFilePath)
